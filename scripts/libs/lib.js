const buy_pot = () => {
	...
	if ((locate_item("hpot0").q < 9999 && locate_item("hpot0").name == "hpot0") || locate_item("hpot0").q == -1)
		console.log("return buy hpot: ", buy("hpot0", 9999 - locate_item("hpot0").q));

	//Less than 9999 mpot0
	if ((locate_item("mpot0").q < 9999 && locate_item("mpot0").name == "mpot0") || locate_item("mpot0").q == -1)
		console.log("return buy mpot: ", buy("mpot0", 9999 - locate_item("mpot0").q));
